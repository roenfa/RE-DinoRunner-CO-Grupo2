...
from dino_runner.utils.constants import BG, ICON, SCREEN_HEIGHT, SCREEN_WIDTH, TITLE, FPS, RUNNING ## AGREGAR RUNNING
from dino_runner.components.dinosaur import Dinosaur
from dino_runner.components.obstacles.obstacle_manager import ObstacleManager
from dino_runner.components.player_hearts.player_heart_manager import PlayerHeartManager ## ADD THIS LINE
...
class Game:
    def __init__(self):
        ...
        self.background = pygame.image.load("dino_runner/components/Desierto.jpg")
        self.points = 0
        self.running = True
        self.death_count = 0
